...
export const SCENARIOS: Scenario[] = [
  {
    ...
    context: "You're at a busy coffee shop. You notice someone attractive waiting in line near you. The goal is to start a natural, light conversation.",
    goals: [
  ...
  },
  {
    ...
    context: "You're at a lively bar. You've made eye contact with someone across the room a few times. Now you're approaching to start a conversation.",
    goals: [
  ...
  },
  {
    ...
    context: "You're on a first date at a nice restaurant. You've been chatting for a few minutes and want to make a great impression while staying genuine.",
    goals: [
